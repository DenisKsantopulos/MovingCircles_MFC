...
// SDI_t.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSDItApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSDItApp::OnAppAbout)
...
CSDItApp::CSDItApp() noexcept
{
	...
	SetAppID(_T("SDIt.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CSDItApp

CSDItApp theApp;


// Инициализация CSDItApp

BOOL CSDItApp::InitInstance()
{
...
// Обработчики сообщений CSDItApp
